...
import os, base64, sys, urllib.request, urllib.error, urllib.parse, urllib.parse
...
class navigator:
	...
	NEWSFILE      = 'https://pastebin.com/raw/4bx6ex5q'
	...
	def root(self):
		...
		self.addDirectoryItem(32075, 'docuHeaven', 'movies.png',  'DefaultMovies.png') 
...
def iptv(self):
		if self.getMenuEnabled('navi.iptv') == True:
			...
			self.addDirectoryItem('Foreign Channels', 'foreigntv', 'networks.png', 'fanart.jpg')  
...
def tools(self):
		...
		self.addDirectoryItem('Resolve Settings', 'smuSettings', 'tools.png', 'DefaultAddonProgram.png')
...
def cf(self):
		...
		self.addDirectoryItem(32051, 'clearMetaCache', 'tools.png', 'DefaultAddonProgram.png')
		self.addDirectoryItem(32608, 'clearAllCache', 'tools.png', 'DefaultAddonProgram.png')
		self.endDirectory()
